...
<html lang="ar" dir="rtl">
  ...
  <body>
    ...
    <!-- Departments Section-->
    <div class="container mt-5 pt-3" id="FE-departments">
      <h2>الاقسام</h2>
      <hr />
      <div class="row align-items-center">
        <div class="col-sm">
          <div class="card mt-2">
            <h4 class="card-header">قسم هندسة الطيران</h4>
            <div class="card-body">
              <p class="card-text">
                مساحة خاصة بمناقشة المواضيع المتعلقة بمواد قسم هندسة الطيران.
              </p>
              <a
                href="department.php"
        ...
        <div class="col-sm">
          <div class="card mt-2">
            <h4 class="card-header">قسم الهندسة الكيميائة</h4>
            <div class="card-body">
              <p class="card-text">
                مساحة خاصة بمناقشة المواضيع المتعلقة بمواد قسم الهندسة
                الكيميائية.
              </p>
              <a
                href="department.php"
        ...
        <div class="col-sm">
          <div class="card mt-2">
            <h4 class="card-header">قسم الهندسة المدنية</h4>
            <div class="card-body">
              <p class="card-text">
                مساحة خاصة بمناقشة المواضيع المتعلقة بمواد قسم الهندسة المدنية.
              </p>
              <a
                href="department.php"
                class="btn btn-outline-primary rounded-pill"
        ...
        <div class="col-sm">
          <div class="card mt-2">
            <h4 class="card-header">قسم الهندسة الصناعية</h4>
            <div class="card-body">
              <p class="card-text">
                مساحة خاصة بمناقشة المواضيع المتعلقة بمواد قسم الهندسة الصناعية.
              </p>
              <a
                href="department.php"
                class="btn btn-outline-primary rounded-pill"
      ...
      <div class="row align-items-center">
        <div class="col-sm">
          <div class="card mt-2">
            <h4 class="card-header">قسم الهندسة الميكانيكية</h4>
            <div class="card-body">
              <p class="card-text">
                مساحة خاصة بمناقشة المواضيع المتعلقة بمواد قسم الهندسة
                الميكانيكية.
        ...
        <div class="col-sm">
          <div class="card mt-2">
            <h4 class="card-header">قسم هندسة التعدين</h4>
            <div class="card-body">
              <p class="card-text">
                مساحة خاصة بمناقشة المواضيع المتعلقة بمواد قسم هندسة التعدين.
              </p>
              <a
                href="department.php"
                class="btn btn-outline-primary rounded-pill"
        ...
        <div class="col-sm">
          <div class="card mt-2">
            <h4 class="card-header">قسم الهندسة النووية</h4>
            <div class="card-body">
              <p class="card-text">
                مساحة خاصة بمناقشة المواضيع المتعلقة بمواد قسم الهندسة النويية.
              </p>
              <a
                href="department.php"
                class="btn btn-outline-primary rounded-pill"
        ...
        <div class="col-sm">
          <div class="card mt-2">
            <h4 class="card-header">قسم الهندسة الكهربائية</h4>
            <div class="card-body">
              <p class="card-text">
                مساحة خاصة بمناقشة المواضيع المتعلقة بمواد قسم الهندسة
                الكهربائية.
    ...
    <div class="container px-4 py-5" id="FE-generalSpace">
    ...
    <div class="container mt-5" id="FE-importantLinks">
      <h2>روابط هامة</h2>
      <hr />
      <div class="row align-items-center">
        <div class="col-sm">
