...
<html lang="ar" dir="rtl">
  ...
  <body>
    ...
    <!--SHARING EXPERIENCES BODY-->
    <div class="container px-4 py-5" id="hanging-icons">
      <div class="text-center">
        <h2 class="pb-2 col-sm" id="depSub">مساحة التدريب الصيفي | التعاوني</h2>
        <p>Co-op Training Space</p>
        <hr />
    ...
    <div class="container px-4 py-5" id="hanging-icons1">
      ...
      <div class="text-center">
        <a
          href="https://www.aramco.com/ar/careers/saudi-applicants/non-employee-programs/university-and-vocational-college-internship-programs/university-internship-program"
          target="_blank"
        >
          <img
            src="../../images/aramco.jpg"
            class="rounded border border-dark-subtle"
            style="width: 350px; height: 300px"
            alt="aramco"
          />
        </a>

        <a href="https://careers.sdaia.gov.sa/training" target="_blank">
          <img
            src="../../images/sadaia.png"
            class="rounded border border-dark-subtle"
            style="width: 350px; height: 300px"
            alt="kaust"
          />
        ...
        <a href="https://cemse.kaust.edu.sa/ssi" target="_blank">
          <img
            src="../../images/kaust.png"
            class="rounded border border-dark-subtle"
