...
<html lang="ar" dir="rtl">
  ...
  <body>
    ...
    <!--FOUNDATION YEAR BODY-->
    <div class="container px-4 py-5" id="hanging-icons">
      <div class="text-center">
        <h2 class="pb-2 col-sm" id="depSub">مساحة السنة التحضيرية</h2>
        <p>Foundation Year General Space</p>
        <hr />
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <li>
            ...
            >
              <div class="ms-2 me-auto">
                <div class="fw-bold fs-5">MATH 110</div>
                <div class="fs-6">Math 1 | رياضيات 1</div>
              </div>
              <span class="badge bg-primary rounded-pill">الردود 7</span>
            </a>
            </li>
            ...
            >
              <div class="ms-2 me-auto">
                <div class="fw-bold fs-5">CHEM 110</div>
                <div class="fs-6">Chemistry 1 | كيمياء 1</div>
              </div>
              <span class="badge bg-primary rounded-pill">الردود 7</span>
            </a>
            </li>
            ...
            >
              <div class="ms-2 me-auto">
                <div class="fw-bold fs-5">PHYS 110</div>
                <div class="fs-6">Physics 1 | فيزياء 1</div>
              </div>
              <span class="badge bg-primary rounded-pill">الردود 7</span>
            </a>
            </li>
            ...
            >
              <div class="ms-2 me-auto">
                <div class="fw-bold fs-5">BIO 110</div>
                <div class="fs-6">Biology 1 | أحياء 1</div>
              </div>
              <span class="badge bg-primary rounded-pill">الردود 7</span>
            </a>
            </li>
            ...
            >
              <div class="ms-2 me-auto">
                <div class="fw-bold fs-5">STAT 110</div>
                <div class="fs-6">Statistics 1 | إحصاء 1</div>
              </div>
              <span class="badge bg-primary rounded-pill">الردود 7</span>
            </a>
            </li>
            ...
            >
              <div class="ms-2 me-auto">
                <div class="fw-bold fs-5">CPIT 100</div>
                <div class="fs-6">
                  Programming 1 (Python) | برمجة 1 (بايثون)
                </div>
              </div>
              <span class="badge bg-primary rounded-pill">الردود 7</span>
            </a>
            ...
            >
              <div class="ms-2 me-auto">
                <div class="fw-bold fs-5">ELI 101</div>
                <div class="fs-6">English Language 1 | اللغة الانجليزية 1</div>
              </div>
              <span class="badge bg-primary rounded-pill">الردود 7</span>
            </a>
            </li>
            ...
            >
              <div class="ms-2 me-auto">
                <div class="fw-bold fs-5">ELI 102</div>
                <div class="fs-6">English Language 2 | اللغة الانجليزية 2</div>
              </div>
